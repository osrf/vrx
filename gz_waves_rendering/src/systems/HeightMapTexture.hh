...
namespace gz::sim::systems
{
  ...
  class HeightMapTexture
  {
    ...
    /// \param[in] _eta   Surface elevation grid → R channel.
    /// \param[in] _dispX Horizontal x-displacement grid → G channel.
    /// \param[in] _dispY Horizontal y-displacement grid → B channel.
    ...
    public: bool Upload(const Eigen::MatrixXd &_eta,
    ...
    public: bool Ready() const { return this->ready_; }
