...
#include <usv_msgs/msg/range_bearing.hpp>
...
class AcousticPinger : public ModelPlugin
{
  ...
  // ROS integration
  /// \brief Pointer to the gazebo plugin ROS node.
  private: gazebo_ros::Node::SharedPtr rosNode;

  /// \brief Subscribes to the topic that set the pinger position.
  public: rclcpp::Subscription<geometry_msgs::msg::Vector3>::SharedPtr setPositionSub;

  /// \brief Publisher used to send sensor messages generated by the plugin.
  private: rclcpp::Publisher<usv_msgs::msg::RangeBearing>::SharedPtr rangeBearingPub;
