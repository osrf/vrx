...
/////////////////////////////////////////////////
PerceptionScoringPlugin::Gate::Gate(
...
/////////////////////////////////////////////////
void PerceptionScoringPlugin::Gate::Update()
{
...
/////////////////////////////////////////////////
PerceptionScoringPlugin::GateState PerceptionScoringPlugin::Gate::IsPoseInGate(
    ...
    sdf::ElementPtr _sdf)
{
  ...
  this->updateConnection = gazebo::event::Events::ConnectWorldUpdateBegin(
    std::bind(&PerceptionScoringPlugin::Update, this));
}

//////////////////////////////////////////////////
bool PerceptionScoringPlugin::ParseGates(sdf::ElementPtr _sdf)
{
  GZ_ASSERT(_sdf, "PerceptionScoringPlugin::ParseGates(): NULL _sdf pointer");
...
//////////////////////////////////////////////////
bool PerceptionScoringPlugin::AddGate(const std::string &_leftMarkerName,
...
//////////////////////////////////////////////////
void PerceptionScoringPlugin::Update()
{
...
//////////////////////////////////////////////////
void PerceptionScoringPlugin::OnReady()
{
...
//////////////////////////////////////////////////
void PerceptionScoringPlugin::OnFinished()
{
